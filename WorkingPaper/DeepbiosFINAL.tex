...
\noindent \author{Rodrigo Riera$^{1,2,*}$, Ali Vadathi$^{3}$, Gian Marco Palamara${^3}$, David Alonso${^4}$, Joaqu\´in Hortal${^5}$, and Carlos J. Meli\´an${^6}$}
            \\
            %TO ADD VICTOR EGUILUZ --- FRANCISCO BALDO -- JON NORBERG -- PAULO GUIMARAES --ALI? 
